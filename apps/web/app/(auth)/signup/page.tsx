...
function SignupForm() {
    ...
    const handleGoogleSignup = async () => {
        ...
        try {
            ...
            if (redirect) {
                localStorage.setItem('oauth_redirect', decodeURIComponent(redirect));
            } else {
            ...
            account.createOAuth2Session(
                ...
                `${origin}/oauth/callback`, // Success redirect
                `${origin}/signup${redirect ? `?redirect=${redirect}` : ''}`, // Failure redirect
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSignup}>
                    ...
                    <div>
                        <button
                            ...
                            disabled={loading || googleLoading}
                            className="group relative w-full flex justify-center items-center gap-3 py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 disabled:opacity-50"
                        >
